...
class LdStatePublisher(Node):
    def __init__(self, listener,_robotname):
        ...
        #self.x = self.listener.robot_name
        self.status_pub = self.create_publisher(Status, self.robotname+"_status", 10)
        ...
        self.ttg_pub = self.create_publisher(String, self.robotname+"_timetogoal", 10)
